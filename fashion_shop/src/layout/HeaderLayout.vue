    ...
    <div id="header">
      <div class="box-logo">
        ...
        <form class="frm-search">
          ...
          <button class="btn-search btn" type="button"><font-awesome-icon icon="fa-solid fa-magnifying-glass" /></button>
        </form>
      </div>
      <div class="box-actions">
        ...
        <div class="list-actions">
          ...
          <button class="btn-basket"><font-awesome-icon icon="fa-solid fa-cart-shopping" style="color: #343a4099;"/><span
              class="item-number pulse">90</span></button>
        </div>
      </div>
    </div>
    <!-- nav -->
